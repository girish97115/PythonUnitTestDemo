...
def test_checkCardValidity():
    assert VerifyCard.checkCardValidity("girish","79927398713","343","03/22")==True
    assert VerifyCard.checkCardValidity("Akash","79927391134","51","04/23")==False
    assert VerifyCard.checkCardValidity("Kar3tik","79927391134","113","03/27")==False
    assert VerifyCard.checkCardValidity("Babu34","79927391134","823","03/03")==False